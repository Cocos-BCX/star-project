...
!function (t) {
  ...
  n.r(e), n.d(e, "default", function () {
    ...
    function e() {
      return c()(this, e), a()(this, p()(e).call(this, Cocosjs.Blockchains.COCOSBCX, Cocosjs.PluginTypes.BLOCKCHAIN_SUPPORT));
    }return d()(e, t), f()(e, [{ key: "setSocketService", value: function value(t) {
        h = t;
      } }, { key: "hookProvider", value: function value() {
        throw new Error("cocos hook provider not enabled yet.");
      } }, { key: "signatureProvider", value: function value() {
        return 0 >= arguments.length || arguments[0], function (t) {
          return function (t, e) {
            return new Proxy(t, e);
          }(t, { get: function get(t, n) {
              return "function" == typeof t[n] ? function () {
                for (var r = arguments.length, o = Array(r), u = 0; u < r; u++) {
                  ...
                  var r;(r = e.methods())[b.transferAsset].apply(r, o).then(function (e) {
                    return t(e);
                  }).catch(function (t) {
                    return n(t);
                  });
                }) : n === b.callContractFunction ? new Promise(function (t, n) {
                  var r;(r = e.methods())[b.callContractFunction].apply(r, o).then(function (e) {
                    return t(e);
                  }).catch(function (t) {
                    return n(t);
                  });
                }) : n === b.creatNHAssetOrder ? new Promise(function (t, n) {
                  var r;(r = e.methods())[b.creatNHAssetOrder].apply(r, o).then(function (e) {
                    return t(e);
                  }).catch(function (t) {
                    return n(t);
                  });
                }) : n === b.transferNHAsset ? new Promise(function (t, n) {
                  var r;(r = e.methods())[b.transferNHAsset].apply(r, o).then(function (e) {
                    return t(e);
                  }).catch(function (t) {
                    return n(t);
                  });
                }) : n === b.fillNHAssetOrder ? new Promise(function (t, n) {
                  var r;(r = e.methods())[b.fillNHAssetOrder].apply(r, o).then(function (e) {
                    return t(e);
                  }).catch(function (t) {
                    return n(t);
                  });
                }) : n === b.cancelNHAssetOrder ? new Promise(function (t, n) {
                  var r;(r = e.methods())[b.cancelNHAssetOrder].apply(r, o).then(function (e) {
                    return t(e);
                  }).catch(function (t) {
                    return n(t);
                  });
        ...
        var t;return t = {}, o()(t, b.transferAsset, function (t) {
          return h.sendApiRequest({ type: "requestTransfer", payload: t });
        }), o()(t, b.callContractFunction, function (t) {
          return h.sendApiRequest({ type: "callContractFunction", payload: t });
        }), o()(t, b.fillNHAssetOrder, function (t) {
          return h.sendApiRequest({ type: "fillNHAssetOrder", payload: t });
        }), o()(t, b.transferNHAsset, function (t) {
          return h.sendApiRequest({ type: "transferNHAsset", payload: t });
        }), o()(t, b.cancelNHAssetOrder, function (t) {
          return h.sendApiRequest({ type: "cancelNHAssetOrder", payload: t });
        }), o()(t, b.creatNHAssetOrder, function (t) {
          return h.sendApiRequest({ type: "creatNHAssetOrder", payload: t });
        }), o()(t, b.getAccountInfo, function () {
          return h.sendApiRequest({ type: "getAccountInfo", payload: {} });
        }), t;
      } }]), e;
  }(Cocosjs.Plugin);"undefined" != typeof window && (window.CocosBCX = m);
}, function (t, e) {
  function n(t) {
